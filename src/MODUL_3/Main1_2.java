...
//class untuk menjalankan persoalan 2
public class Main1_2 {
    ...
    public static void main(String[] args) {
        ...
        //fun.sortInsertion(list) merupakan pemanggilan method fun beserta fungsi sortInsertion didalamnya
        //data yang akan di sorting yaitu data pada list
        Fun.print(list);
        System.out.println();
        Fun.sortInsertion(list);
